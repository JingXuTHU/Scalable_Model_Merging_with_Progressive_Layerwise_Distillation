...
from baseline.regmean_utils import *
from utils import *
...
if __name__ == '__main__':
    dir_path = f'./results/regmean/{args.model}/{args.val_shot}/{args.reduce_non_diagonal_ratio}'
    ...
    exclude_param_names_regex = ["^(?!.*visual).*"]

    merged_param = regmean_merging(image_encoders_arr, dataloader_arr, exclude_param_names_regex,
                                   args.val_shot, args.reduce_non_diagonal_ratio, args.device)
    ...
    if args.save_model:
        ...
        torch.save(image_encoder, f'{save_path}/regmean.pt')
